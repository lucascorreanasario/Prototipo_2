...
# ========= Layout ========= #
layout = dbc.Card([
                html.H1("LauziCash", className="text-primary"),
                html.P("Controle Financeiro", className="text-info"),
                html.Hr(),


    # Seção PERFIL ------------------------
                dbc.Button(id='botao_avatar',
                    children=[html.Img(src="/assets/img_homed.png", id="avatar_change", alt="Avatar", className='perfil_avatar'),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        ...
                        dbc.Row([
                            dbc.Col([
                                dbc.Card([
                                    dbc.CardImg(src="/assets/img_homed.png", top=True, className='perfil_avatar'),
                                    dbc.CardBody([
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                    dbc.Label("Descrição: "),
                                    dbc.Input(placeholder="Ex.: Gasolina, Restaurante...", id="txt-receita"),
                            ], width=6), 
                            dbc.Col([
                                    dbc.Label("Valor: "),
